                ...
                <div class="content-responsive">
                    <div class="content-wrapper">
                        <div class="table-title row">
                            ...
                            <div class="col-sm-7">
                                <a data-target="#addProductModal" data-toggle="modal" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Save</span></a>
                            </div>
                        </div>
                        <div class="container">
                            <form action="MainController" method="POST">
                                <div class="row">
                                    <h3 class="post-headline mt-15">Title</h3>
                                ...
                                <div class="row justify-content-center mt-15">
                                    <button type="button" name="recipeImage">Add source</button>
                                </div>
                                <div class="row">
                                ...
                                <h3 class="post-headline row mt-15">Prep Time</h3>
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <h3 class="post-headline row mt-15">Cooking Time</h3>
                                <div class="row">
                                    <div class="col-6">
