                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="mm-active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="manageRecipes.jsp" class="mm-active">
                                                <i class="metismenu-icon"></i>Manage Recipes
                                            </a>
                                        </li>
                                        <li>
                                            <a href="manageComments.jsp">
                                    ...
                                    <table style="width: 100%;" class="table table-hover table-striped table-bordered">
                                        ...
                                        <tbody>
                                             <tr>
                                                ...
                                                <td>When it comes to chicken breast recipes, its hard to beat this one. The sauce is simple, but so flavorful. It's full of garlic, tomatoes, and most importantly, cream. It's bright and easy and just as good in the summer as it is in the winter.</td>
                                                <td>Null</td>
                                                <td>33min</td>
                                                <td>2008/11/28</td>
                                                <td>162,700</td>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm"><a href="manageRecipesDetails.jsp" style="color: #FFF">Post</a></button>
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm"><a href="manageRecipesDetails.jsp" style="color: #FFF">Remove</a></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
