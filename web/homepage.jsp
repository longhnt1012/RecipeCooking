...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="ShowCategoriesController">Categories</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="newsletter-form">
                                <form action="#" method="post">
                                    <input type="text" name="newsletter-email" id="email" placeholder="Feedback">
    ...
    <!-- ****** Blog Area End ****** -->
    <h1 style="text-align: center"><a class="nav-link" href="#">Categories</a></h1>
