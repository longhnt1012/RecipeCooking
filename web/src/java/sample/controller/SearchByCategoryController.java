...
import sample.detailCategory.DetailCategoryDAO;
import sample.detailCategory.DetailCategoryDTO;
...
//            Get list detailcategories by categoryID
            ...
            List<DetailCategoryDTO> detailcategorydto = detailcategorydao.search(categoryID);
//            Get Recipe Name by recipeID from detailcategories
            ...
            if(Size > 0) {
                for (int i = 0; i < Size; i++) {
                    String recipeID = detailcategorydto.get(i).getRecipeID();
