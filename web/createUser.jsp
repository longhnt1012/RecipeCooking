                                                                ...
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="text" name="userName"/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="text" name="gmail"/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="text" name="role" value="USER" readonly=""/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="date" name="dob"/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="text" name="phone"/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span class="pr-2"><input type="password" name="password"/></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left flex2">
                                                                        <div class="widget-heading">
                                                                            ...
                                                                            <button class="btn btn-primary btn-sm" type="submit" value="Create" name="action"/>Create
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
