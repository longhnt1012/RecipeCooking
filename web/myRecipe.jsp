<%-- 
    Document   : myRecipe
    Created on : Jul 19, 2023, 12:38:50 PM
    Author     : phamt
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div style="background-color: rgba">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12" style="text-align: center;"><h1>My Recipe</h1></div>
                            ...
                            <div class="col-6 col-md-3 col-lg-3 my-favorite">
                                <div class="single-post wow fadeInUp" data-wow-delay=".4s">
                                    ...
                                    <div class="post-thumb">
                                        <a>
                                            <img src="${recipe.image}" alt="" style="height: 180px; width: 100%; margin-bottom: 10px">
                                        </a>
                                    </div>
                                    <!-- Post Content -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-10 col-md-10 col-lg-10" style="text-align: center">
                                                <a href="MainController?action=RecipeDetail&recipeID=${recipe.recipeID}">
                                                    <h4 class="post-headline" style="text-align: center; font-size: 27px">${recipe.recipeName}</h4>
                                                </a>
                                            </div>
                                            <div class="col-2 col-md-2 col-lg-2">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                                    <form action="MainController?recipeID=${recipe.recipeID}&userID=${LOGIN_USER.userID}" method="POST">
                                                        <button class="dropdown-item" type="submit" name="action" value="RemoveRecipeByRecipeID">Remove</button>
                                                        <button class="dropdown-item" type="submit" name="action" value="LoadRecipeDetailForEdit">Edit</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
