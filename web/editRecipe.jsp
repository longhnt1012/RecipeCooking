                                ...
                                <ul class="form-control col-12 col-md-12 col-lg-12" style="display: flex" >
                                    <div class="col-6 col-md-6 col-lg-6">
                                        <li class="col-12 col-md-12 col-lg-12" style="padding: 8px">
                                            <input type="checkbox" style="margin-right: 20px" value="B" name="meal" <c:if test="${RECIPE_DETAIL.meal == '[B]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal == '[B, L]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, D]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, L, D]'}">checked</c:if>>Breakfast</li>
                                            <li class="col-12 col-md-12 col-lg-12" style="padding: 8px" >
                                                            <input type="checkbox" style="margin-right: 20px" value="D" name="meal" <c:if test="${RECIPE_DETAIL.meal == '[L]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, L]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[T, C]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, L, D]'}">checked</c:if>>Lunch</li>
                                            <li class="col-12 col-md-12 col-lg-12" style="padding: 8px">
                                                            <input type="checkbox" style="margin-right: 20px;" value="L" name="meal" <c:if test="${RECIPE_DETAIL.meal == '[D]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[L, D]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, D]'}">checked</c:if> <c:if test="${RECIPE_DETAIL.meal.trim() == '[B, L, D]'}">checked</c:if>>Dinner</li>
                                        </div>
                                    </ul>
                            ...
                            <div id="inputIngredient">
                                <div class="row">
                                    <c:forEach var="ingredient" items="${LIST_INGREDIENT}">
                                        ...
                                        <div class="col-2"> 
                                            <input class="form-control" required type="number" step="0.1" name="quantity" min="0" value="${ingredient.quantity}" style="margin-left: 10px">
                                        </div>
        ...
        <script>
            ...
            function addMoreIngredients() {
                ...
                newInput.innerHTML =
                        ...
                        '</div>' +
                        '<div class="col-2">' +
                        '<input class="form-control" type="number" step="0.1" name="quantity" min="0" placeholder="Amount" style="margin-left: 10px">' +
                        '</div>' +
                        '<div class="col-2" style="display: inline-table,margin-top: 2px">' +
