                                    ...
                                    <div class="personal-info-body col-12 col-md-12 col-lg-12" style="margin-top:10px; ">
                                        <form action="MainController" method="post">
                                            ...
                                            <div class="form-group first">
                                                ...
                                                <input type="text" class="form-control" placeholder="Your name" id="firstName" name="userName" value="${LOGIN_USER.userName}">
                                            </div>
                                            <div class="form-group first">
                                                <label for="name">Image</label>
                                                <input type="text" class="form-control" placeholder="https://........" id="lastName" name="imageUser" value="${LOGIN_USER.imageUser}">
                                            </div>
                                            <div class="form-group first">
                                                <label for="phone">Phone</label>
                                                <input type="text" class="form-control" placeholder="Your phone" id="phone" name="phone" value="${LOGIN_USER.phone}">
                                            </div>
                                            <div class="form-group first">
                                                <label for="dob">Date of birth</label>
                                                <input type="date" class="form-control" placeholder="" id="dob" name="dob" value="${LOGIN_USER.dob}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="gender" class="form-label">Gender:</label>
                                                <input type="radio" name="gender" <c:if test="${LOGIN_USER.gender == 'false'}">checked="checked"</c:if> value="0" required="required">Male
                                                <input type="radio" name="gender" <c:if test="${LOGIN_USER.gender == 'true'}">checked="checked"</c:if> value="1" required="required">Female
                                                </div>
                                                <p style="color:red">${message}</p>
                                            <p style="color:green">${success}</p>
                                            <button type="submit" name="action" value="SaveProfile" class="btn btn-success">Save</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
