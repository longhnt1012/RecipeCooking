                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="LoadUsersController" style="margin: 10px 0xp;">
                                ...
                                <div class="card-body">
                                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="recipe" items="${LIST_RECIPES}">
                                                <tr>
                                                    ...
                                                    <c:if test="${recipe.status == 1}">
                                                        <td class="text-center">
                                                            <div class="badge badge-success">Active</div>
                                                        </td>
                                                    </c:if>

                                                    <c:if test="${recipe.status == 2}">
                                                        <td class="text-center">
                                                            <div class="badge badge-warning">Inprogress</div>
                                                        </td>
                                                    </c:if>

                                                    <c:if test="${recipe.status == 0}">
                                                        <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <c:choose>
                                                            <c:when test="${recipe.status == 0 || recipe.status == 2}">
                                                        ...
                                                        <form action="ManageRecipeController" method="POST">
                                                            <input type="hidden" name="recipeID" value="${recipe.recipeID}"/>
                                                            <button type="submit" name="action" value="Detail" id="PopoverCustomT-1" class="btn btn-primary btn-sm" style="margin:10px 0px">Details</button>
                                                        </form>
                                                        <form action="LoadCategoryOfRecipesController" method="POST">
                                                            <input type="hidden" name="recipeID" value="${recipe.recipeID}"/>
                                                            <button type="submit" name="action" value="Tag" id="PopoverCustomT-1" class="btn btn-primary btn-sm">Tag</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </c:forEach>
