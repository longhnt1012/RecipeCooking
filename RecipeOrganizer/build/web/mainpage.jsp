            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".3s">
                        <img src="img/category-img/1.jpg" alt="" style="width: 350px;height:220px">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
                        <img src="img/category-img/2.jpg" alt="" style="width: 350px;height:220px">
                        <div class="catagory-title">
                            <a href="#">
                                <h5>Healthy Salad</h5>
                            </a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".9s">
                        <img src="img/category-img/3.jpg" alt="" style="width: 350px;height:220px">
                        <div class="catagory-title">
                            <a href="#">
                                <h5>Eat clean</h5>
                            </a>
                    ...
                    <ul class="toptrending">
                        <li style="margin-bottom: 30px;">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-6">
                                  <a href="pho.html"><h3>Homemade Pho</h3></a>
                        ...
                        <li style="margin-bottom: 30px;">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-6">
                                    <a href="chickenfries.html"><h5>Chicken Fries</h5></a>
                    ...
                    <ul class="toptrending">
                        ...
                        <li style="margin-bottom: 30px;">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-6">
                                   <a href="baked-salmon-recipes.html">
