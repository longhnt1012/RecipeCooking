...
public class LoginController extends HttpServlet {
    ...
    private static final String US_PAGE = "LoadRecipesController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO user = uf.login(gmail, password);
            //PHAN QUYEN
            if (user.getRole().equals("USER") && user.isStatus() == true) {
                ...
                request.setAttribute("message", "alert('Incorrect email or password')");
                url = LOGIN_PAGE;
            }
        } catch (Exception e) {
            e.printStackTrace();
