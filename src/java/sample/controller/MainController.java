...
public class MainController extends HttpServlet {
    ...
    private static final String SEARCHBYCATEGORY = "SearchByCategory";
    private static final String SEARCHBYCATEGORY_CONTROLLER = "SearchByCategoryController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action == null) {
                ...
                url = SEARCHBYCATEGORY_CONTROLLER;
            } else {
