...
public class CategoryDAO {
    ...
    private static final String SHOWALL = "SELECT * FROM tblCategories";
    private static final String SEARCHBYCATEGORY = "SELECT categoryID FROM tblCategories WHERE categoryName = ?";
    ...
    public List<CategoryDTO> getListCategories() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                listcategories.add(new CategoryDTO(categoryID, categoryName, picture));
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
