 ...
 * @author Thành Long
 */
@WebServlet(name = "SavedPageController", urlPatterns = {"/SavedPageController"})
public class SavedPageController extends HttpServlet {

    private static final String SUCCESS="saved.jsp";
