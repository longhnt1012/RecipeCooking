 ...
 * @author Thành Long
 */
@WebServlet(name = "RemoveFavoriteRecipeController", urlPatterns = {"/RemoveFavoriteRecipeController"})
public class RemoveFavoriteRecipeController extends HttpServlet {
