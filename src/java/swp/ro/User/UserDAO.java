...
public class UserDAO {
    ...
    public static final String LOGIN_BY_EMAIL = "SELECT * FROM [User] WHERE gmail = ? and [password] = ?";
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (rs.next()) {
                    ...
                    loginUser = new UserDTO(userID, userName, dob, gender, phone, gmail, password, role, status, imageUser);
                }
            }
        } catch (Exception e) {
        } finally {
...
//                    user.setLastName(rs.getString("lastName"));
    ...
    public UserDTO loginByEmail(String gmail, String password) throws SQLException, NoSuchAlgorithmException, ClassNotFoundException {
        UserDTO user = null;
        Connection con = DBUtil.DBContext.getConnection();
